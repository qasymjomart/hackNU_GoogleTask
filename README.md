Text images matching solution for problem from Google in HackNU international hackathon. Weights of the model are not present in the repository and can be downladed from 
